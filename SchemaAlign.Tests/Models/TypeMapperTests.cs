...
public class TypeMapperTests
{
    ...
    [InlineData("datetime2(7)", StandardType.DateTime, null)]
    [InlineData("datetime(7)", StandardType.DateTime, null)]
    [InlineData("timestamp", StandardType.DateTime, null)]
    [InlineData("datetimeoffset", StandardType.DateTimeOffset, null)]
    [InlineData("datetimeoffset(7)", StandardType.DateTimeOffset, null)]
    ...
    [InlineData("time(7)", StandardType.Time, null)]
    [InlineData("int(10)", StandardType.Int, null)]
